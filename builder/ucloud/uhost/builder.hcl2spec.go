...
type FlatConfig struct {
	...
	ImageDestinations         []common.ImageDestination `mapstructure:"image_copy_to_mappings" cty:"image_copy_to_mappings"`
...
func (*Config) HCL2Spec() map[string]hcldec.Spec {
	s := map[string]hcldec.Spec{
		...
		"image_copy_to_mappings":       &hcldec.BlockListSpec{TypeName: "image_copy_to_mappings", Nested: &hcldec.BlockSpec{TypeName: "image_copy_to_mappings", Nested: hcldec.ObjectSpec((*common.ImageDestination)(nil).HCL2Spec())}},
