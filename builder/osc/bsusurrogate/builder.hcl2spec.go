...
type FlatConfig struct {
	...
	RootDevice                  *RootBlockDevice                   `mapstructure:"omi_root_device" cty:"omi_root_device"`
...
func (*Config) HCL2Spec() map[string]hcldec.Spec {
	s := map[string]hcldec.Spec{
		...
		"source_omi_filter":                    &hcldec.BlockSpec{TypeName: "source_omi_filter", Nested: hcldec.ObjectSpec((*common.OmiFilterOptions)(nil).HCL2Spec())},
		...
		"net_filter":                           &hcldec.BlockSpec{TypeName: "net_filter", Nested: hcldec.ObjectSpec((*common.NetFilterOptions)(nil).HCL2Spec())},
		...
		"omi_block_device_mappings":            &hcldec.BlockListSpec{TypeName: "omi_block_device_mappings", Nested: &hcldec.BlockSpec{TypeName: "omi_block_device_mappings", Nested: hcldec.ObjectSpec((*common.BlockDevice)(nil).HCL2Spec())}},
		"launch_block_device_mappings":         &hcldec.BlockListSpec{TypeName: "launch_block_device_mappings", Nested: &hcldec.BlockSpec{TypeName: "launch_block_device_mappings", Nested: hcldec.ObjectSpec((*common.BlockDevice)(nil).HCL2Spec())}},
		...
		"omi_root_device":                      &hcldec.BlockSpec{TypeName: "omi_root_device", Nested: hcldec.ObjectSpec((*RootBlockDevice)(nil).HCL2Spec())},
